...
#Aliases
alias inst='sudo pacman -Syyy'
alias ls='exa -aG --sort=type'
alias ll='exa -aglhHS -s type --icons'
alias pcup='sudo pacman -Syyu'
alias rofirun='rofi -show run'
alias tlmgr='/usr/share/texmf-dist/scripts/texlive/tlmgr.pl --usermode'
alias ytdn='youtube-dl -f bestaudio --extract-audio --audio-format mp3 --audio-quality 0 -o "$HOME/Downloads/youtube-dl_songs/%(channel)s/%(title)s - %(channel)s.%(ext)s"'
alias yay='paru'
